# Architecture Specification: UniERP Configuration & Secrets Platform (`config`)
...
```mermaid
graph LR
  Callers["Allowed Inbound Callers<br/>L2-L7"] --> Repo["<b>config (L1)</b><br/>UniERP Configuration & Secrets Platform"]
  Repo --> Outbound["Allowed Outbound Dependencies<br/>@kannan19302/contracts (L0)"]
  
  Forbidden["Strictly Forbidden<br/>Layers L2-L7, Direct business runtime logic"] -.-x Repo
...
- **Core Runtime & Languages**: TypeScript, Zod, Vitest
- **Primary Interface**: `@kannan19302/config`
...
- **Project Skill**: [`.agents/skills/config-governance-standards/SKILL.md`](.agents/skills/config-governance-standards/SKILL.md)
